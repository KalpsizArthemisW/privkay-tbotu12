...
module.exports.run = async (client, message, users, args) => {
    ...
    return message.reply("<a:redtik:791262256041426975> Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.")
...
if(isimler === null) isimler = "<a:redtik:791262256041426975> Kullanıcı hiç kayıt olmamış"
if(isimler === undefined) isimler = "<a:redtik:791262256041426975> Kullanıcı hiç kayıt olmamış"
//------------------------------------------------KAYITLAR-----------------------------------------------\\      
