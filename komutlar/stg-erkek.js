...
if(!['791259710258675726'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
return message.reply(`Bu Komut İçin Yetkiniz Bulunmamaktadır.`) 
  
const erkek = message.guild.roles.cache.find(r => r.id === '791246025460416521')
...
<a:greentik:791262213435686932> ${erkek},  Roller Verildi.
<a:greentik:791262213435686932> İsmi \`${tag} ${name} | ${age}\` Olarak Güncellendi.`) 
.setFooter(`${message.author.username} Toplam ${alldata} Kayıta Sahip. <a:greentik:791262213435686932>`)
.setColor("RANDOM")
...
.addField(`<a:greentik:791262213435686932> Roller`, `${erkek}, `, true)
